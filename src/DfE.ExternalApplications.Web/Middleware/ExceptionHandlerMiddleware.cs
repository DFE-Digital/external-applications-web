...
using ValidationException = DfE.ExternalApplications.Application.Exceptions.ValidationException;

namespace DfE.ExternalApplications.Web.Middleware
{
    public class ExceptionHandlerMiddleware(RequestDelegate next, ILogger<ExceptionHandlerMiddleware> logger)
    {
        private static readonly string? _responseContentType = "applciation/json";
    ...
    public static class ExcepetionHandlerMiddlewareExtensions
    {
